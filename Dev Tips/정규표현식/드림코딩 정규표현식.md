...
- `\b`: 단어 경계
  ...
  - ![[assets/images/b0ed8bb9eff9edd1f53fc49232e86c79_MD5.png]]
  - `Ya\b`: 단어 뒤에서만 사용되는 Ya만 뽑는다.
  - ![[assets/images/b44d2140e5d5691ea33b7f1cb7f533fa_MD5.png]]
- `\B`: 단어 경계가 아님
  - `Ya\B`: 단어 뒤에서 사용되는 Ya를 제외한 Ya를 뽑는다.
  - ![[assets/images/baa82c5707df9d7523169e779289fee6_MD5.png]]
- `^`: 문장의 시작
  - `^Ya`: Ya로 시작하는 문장의 단어를 가져옴
  - ![[assets/images/212da651c8bfb2d720e4adbd97ea0d18_MD5.png]]
- `$`: 문장의 끝
  - `Ya$`: Ya로 끝나는 문장의 단어를 가져옴
  - ![[assets/images/3c6e05f8451d7a6248d769b5c930e51c_MD5.png]]
