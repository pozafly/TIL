...
![[assets/images/f883bc49ef4d5684cc61514a3587cee9_MD5.png]]
...
```
![[assets/images/a00dc49163c64662b03367ca4363c67b_MD5.png]]

force-cache는 위와 같은 순서로 이루어진다. 캐시 히트 상태가 되면 백엔드 서버에 가는 것이 아니라 Next.js의 node 서버에서 캐싱해둔 것을 꺼내 사용하는 방식이다.

![[assets/images/d032d88d8f9866a3fc4dff4fd3ddde30_MD5.png]]

이렇게 cache hit 이 잘 뜨는 것을 볼 수 있음.

![[assets/images/5878bab1a373930a2fbb138a50e907f3_MD5.png]]
...
```
![[assets/images/40edb6258fef7797791978683bc1d2bf_MD5.png]]
